...
EOF
     ...
     * @param null|string $input
     *
     * @dataProvider provideFixTreatSameNamespaceAsUsedCases
     */
    public function testFixTreatSameNamespaceAsUsed($expected, $input = null)
    {
        $this->fixer->configure([
            'treat_same_namespace_as_unused' => false,
        ]);
        $this->doTest($expected, $input);
    }

    public function provideFixTreatSameNamespaceAsUsedCases()
    {
        return [
            'simple' => [
                <<<'EOF'
